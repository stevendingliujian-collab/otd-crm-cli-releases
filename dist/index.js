...
const dict_1 = require("./commands/dict");
const user_1 = require("./commands/user");
const company_1 = require("./commands/company");
...
`);
    ...
    (0, dict_1.dictCommands)(program);
    (0, user_1.userCommands)(program);
    (0, company_1.companyCommands)(program);
