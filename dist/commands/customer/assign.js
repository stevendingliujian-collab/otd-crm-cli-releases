...
function assignCommand(customer) {
    customer
        ...
        try {
            ...
            if (options.ownerId) {
                ...
                if (users.length > 1) {
                    ...
                    if (options.json) {
                        ...
                        console.log('');
                        formatter_1.formatter.info(`Usage: crm customer assign ${id} --owner-id <id>`);
                    }
                    process.exit(1);
                }
                // Single match found
            ...
            // Step 2: Get current customer info
            if (options.verbose) {
            ...
            if (options.json) {
                ...
                formatter_1.formatter.success(`✅ Customer assigned successfully`);
